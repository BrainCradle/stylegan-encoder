...
def main():
    ...
    parser.add_argument('--model_url', default='https://drive.google.com/uc?id=1m1nkLeblJSPBKx5bwbHCElcIxn-kCNm3', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    if (args.use_lpips_loss > 0.00000001):
        with dnnlib.util.open_url('https://drive.google.com/uc?id=1_tjMu8HTxAPnR0dngPV-K3hZC8Dgfk4B', cache_dir=config.cache_dir) as f:
